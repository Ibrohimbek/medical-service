...
-- Дамп структуры для таблица medical_service.authassignment
CREATE TABLE IF NOT EXISTS `authassignment` (
  ...
  KEY `fk_authassignment_user_ID_idx` (`userid`),
  CONSTRAINT `authassignment_ibfk_1` FOREIGN KEY (`itemname`) REFERENCES `authitem` (`name`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_authassignment_user_ID` FOREIGN KEY (`userid`) REFERENCES `user` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- Дамп данных таблицы medical_service.authassignment: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `authassignment` DISABLE KEYS */;
/*!40000 ALTER TABLE `authassignment` ENABLE KEYS */;


-- Дамп структуры для таблица medical_service.authitem
...
-- Дамп данных таблицы medical_service.authitem: ~0 rows (приблизительно)
/*!40000 ALTER TABLE `authitem` DISABLE KEYS */;
/*!40000 ALTER TABLE `authitem` ENABLE KEYS */;


-- Дамп структуры для таблица medical_service.authitemchild
...
-- Дамп данных таблицы medical_service.authitemchild: ~0 rows (приблизительно)
...
-- Дамп структуры для таблица medical_service.rights
...
-- Дамп данных таблицы medical_service.rights: ~0 rows (приблизительно)
